...
@section('content')
    <div class="h-screen flex items-center bg-gray-200">
        <form method="POST" action="{{ route('pedido.checkout') }}" id="checkout" class="w-full max-w-xl mx-auto bg-white rounded shadow-xl relative py-4">
            @csrf
            <div class="text-gray-900 font-medium text-xs text-center flex flex-col items-center justify-center">
                <img class="h-20 w-20 rounded-full shadow-xl border-4 border-gray-400" src="https://cdn.iconscout.com/icon/free/png-512/free-checkout-1553147-1314013.png?f=webp&w=256" alt="logo">
            ...
            <div class="py-2 px-4 md:px-8">
                ...
                <div class="bg-gray-200 rounded py-2">
                    ...
                    <div class="mb-1 p-2">
                        ...
                        <input id="direccion" name="direccion" type="text" placeholder="Dirección (Pais, Poblado, Municipio, Calle, Numero)" required class="w-full px-2 py-1 lg:px-4 lg:py-2 text-gray-700 bg-gray-100 text-xs lg:text-sm border border-gray-300 rounded-lg focus:outline-none focus:bg-white">
                    </div>

                    <div class="w-full">
                        <div class=" my-1 p-2">
                            <label for="datosTarjeta" class="text-xs text-gray-700">Información de la tarjeta</label>
                            <input type="text" name="datosTarjeta" id="datosTarjeta" required class="w-full px-2 py-1 lg:px-4 lg:py-2 text-gray-700 bg-gray-100 text-xs lg:text-sm border border-gray-300 rounded-lg focus:outline-none focus:bg-white" placeholder="Numero de Tarjeta">
