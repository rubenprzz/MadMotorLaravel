        ...
        <form action="{{ route('piezas.update', $pieza->id) }}" method="post">
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div class="form-group">
                    ...
                    <input class="form-control" name="nombre" placeholder="{{$pieza->nombre}}" value="{{$pieza->nombre}}" type="text"
                ...
                <div class="form-group">
                    ...
                    <input id="precio" class="form-control" name="precio" placeholder="{{$pieza->precio}}" value="{{$pieza->precio}}" type="number"
                           class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                <div class="form-group">
                    <label class="text-white dark:text-gray-200" for="cantidad" id="cantidad">Cantidad</label>
                    <input id="cantidad" class="form-control" name="cantidad" placeholder="{{$pieza->cantidad}}" value="{{$pieza->cantidad}}"
                           type="number"
                           class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                </div>
                ...
                <div>
                    ...
                    <select class="form-control" id="categoria_id" name="categoria_id" placeholder="{{$pieza->categoria->nombre}}"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
